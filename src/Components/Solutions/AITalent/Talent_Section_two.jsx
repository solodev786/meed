      ...
      <div className=" flex flex-col gap-10 w-full">
        <div className=" px-5 md:px-20 flex flex-col gap-10 md:w-4/5">
          <h1 className="  md:text-xl font-light">
            ...
            able to act swiftly and bring on new talent at a moment's notice. 
          </h1>
          <h1 className=" md:text-xl font-light">
            ...
            into people who may not end up working for the business long-term or
            who may not be good cultural fits.
          </h1>
          <h1 className=" md:text-xl font-light">
        ...
        <div className=" w-full md:flex items-center text-white">
          <div className=" md:w-1/5 h-72 bg-black  py-10 flex items-start">
          ...
          <div className=" md:w-1/5 h-72 bg-[#222222]  py-10 flex items-start">
            <div className=" flex items-start gap-3">
              <BiSolidRightArrow className=" text-xl  flex flex-shrink-0" />
              <div className=" flex flex-col gap-4">
          ...
          <div className=" md:w-1/5 h-72 bg-[#333333]  py-10 flex items-start">
            <div className=" flex items-start gap-3">
              <BiSolidRightArrow className=" text-xl  flex flex-shrink-0" />
              <div className=" flex flex-col gap-4">
          ...
          <div className=" md:w-1/5 h-72 bg-[#444444]  py-10 flex items-start">
            <div className=" flex items-start gap-3">
              <BiSolidRightArrow className=" text-xl  flex flex-shrink-0" />
              <div className=" flex flex-col gap-4">
                ...
                <h1 className=" w-4/5 font-extralight">
                  Conduct first stage interviews and receive feedback
                </h1>
              </div>
            </div>
          </div>
          <div className=" md:w-1/5 h-72 bg-[#555555]  py-10 flex items-start">
            <div className=" flex items-start gap-3">
              <BiSolidRightArrow className=" text-xl  flex flex-shrink-0" />
              <div className=" flex flex-col gap-4">
                ...
                <h1 className=" w-4/5 font-extralight">
                  Proceed with 2nd and 3rd stage interviews within 7 days of the
          ...
          <div className="px-5 md:px-20 md:flex w-full justify-center items-center gap-10">
            <div className=" mb-5 md:mb-0 md:w-96 h-80 bg-gray-200 flex items-center px-10 py-5">
              <div className=" flex flex-col gap-5">
                ...
                <h1 className=" font-light">
                  ...
                  hires, as on average it will take from 5-10 days to fill your
                  roles
                </h1>
              </div>
            </div>
            ...
            <div className="mb-5 md:mb-0 md:w-96 h-80 bg-gray-200 items-center px-10 py-10 ">
              <div className=" flex flex-col gap-5">
                ...
                <h1 className=" font-light">
                  The consistent feedback loop ensures your needs are being met
